...
<head>
    ...
    <link rel="stylesheeet" href="topiccard/scoring_star.js">
    ...
    <script>
      ...
      function view_toggle(){
        if(document.getElementById('tp_post_form').dataset.view != "show"){
          document.getElementById('tp_post_form').dataset.view = "show";
        }else{
          document.getElementById('tp_post_form').dataset.view = "hide";
        }
      }
...
<body>
   ...
   <main>
      ...
      <section id="topic_area">
          <div class="tp_post_trigger" onclick="view_toggle()">
            <img src="img/plus.svg">
          </div>
          <div id="tp_post_form">
            <div class="tp_post_box">
              <?php include('include/topic_entry.php') ?>
            </div>
          </div>
          
      </section>
      <div class="topic_load" onclick="callTopic();"><p>次の5件を表示</p></div>
   </main>
   <footer>
      <p>ここはふったーだよ</p>
   </footer>
